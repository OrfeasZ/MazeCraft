...
Application::~Application()
{
	...
	Managers::LightManager::DestroyInstance();
...
#ifdef _DEBUG
	Util::Log::GetInstance()->Init(Util::LogLevel::All, "MazeCraft", false);
#else
	Util::Log::GetInstance()->Init(Util::LogLevel::Warn, "MazeCraft", false);
#endif
...
bool Application::InitManagers()
{
	...
	if (!Managers::LightManager::GetInstance()->Init())
		return false;
