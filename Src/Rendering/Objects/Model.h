...
namespace Rendering
{
	...
	namespace Objects
	{
		...
		protected:
			Model(Managers::Shader::Program* p_ShaderProgram);
		...
		public:
			...
			inline glm::vec4 Color() const { return m_ModelColor; }
			inline void Color(glm::vec4 p_Color) { m_ModelColor = p_Color; }
			...
			inline void Shininess(float p_Shininess) { m_Shininess = p_Shininess; }
